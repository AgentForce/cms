 ...
 * Contact form page.
 */
exports.getPermission = (req, res) => __awaiter(this, void 0, void 0, function* () {
    ...
    try {
        ...
        // req.params.size = 5;
        let res_api;
        res_api = yield api.apiGet(req.user.access_token, process.env.DATA_OAUTH_URI + "api/permissions/" + req.params.page + "/" + size);
        if (res_api.total > 0) {
 ...
 */
exports.postPermission = (req, res) => __awaiter(this, void 0, void 0, function* () {
    try {
